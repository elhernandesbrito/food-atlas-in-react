...
A lista de países exibida depende exclusivamente das áreas culinárias disponíveis na API. Nem todos os países do mundo estão representados, uma vez que apenas regiões que possuem pratos cadastrados são retornadas.
